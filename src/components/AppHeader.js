...
import { setSidebarShow, setAsideShow, setTheme } from 'src/redux/slices/userInterfaceSlice'
import {
  CContainer,
  CDropdown,
  CDropdownItem,
...
const AppHeader = () => {
  ...
  const asideShow = useSelector((state) => state.userInterface.asideShow)
  ...
  // Helper function to update both ColorMode and Redux state
